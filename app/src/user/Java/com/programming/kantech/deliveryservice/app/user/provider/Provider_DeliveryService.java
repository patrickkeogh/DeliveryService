...
import static com.programming.kantech.deliveryservice.app.user.provider.Contract_DeliveryService.PlaceEntry;
...
public class Provider_DeliveryService extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         */
        uriMatcher.addURI(Constants.CONTENT_AUTHORITY, Contract_DeliveryService.PATH_PLACES, PLACES);

        // replaces # with int id
        uriMatcher.addURI(Constants.CONTENT_AUTHORITY, Contract_DeliveryService.PATH_PLACES + "/#", PLACE_WITH_ID);
