...
public class Activity_Main_old extends AppCompatActivity implements
        OnMapReadyCallback,
    ...
    protected void onPause() {
        ...
        // database read listeners will be re attached when the map is loaded
    ...
    private void checkIfAuthorized(FirebaseUser user) {
        ...
        Intent intent = new Intent(Activity_Main_old.this, Activity_NewDriverRequest.class);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) !=
            ...
            ActivityCompat.requestPermissions(Activity_Main_old.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, Constants.REQUEST_CODE_LOCATION_PERMISSION);
        }
